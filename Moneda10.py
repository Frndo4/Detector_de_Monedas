...
#El sticker del meme sabroso
            
            if area<14000 and area>13000:
                font=cv2.FONT_HERSHEY_SIMPLEX
                cv2.putText(imagen_A6, "$10.00",(x,y) , font, 0.75, (0,255,0),2)
                suma3=suma3+10
            
            if area<12000 and area>11000:
                font=cv2.FONT_HERSHEY_SIMPLEX
                cv2.putText(imagen_A6, "$5.00",(x,y) , font, 0.75, (0,255,0),2)
                suma1=suma1+5
            
            if area<9000 and area>8000:
                font=cv2.FONT_HERSHEY_SIMPLEX
                cv2.putText(imagen_A6, "$2.00",(x,y) , font, 0.75, (0,255,0),2)
                suma4=suma4+2

            if area<8000 and area>7000:
                font=cv2.FONT_HERSHEY_SIMPLEX
